...
| R7 | Dynamic Reproduction Agent requirements·간단한 plan·PoC, Setup recipe·환경·정리, Controller 외부 경계, Session Manager AgentLog·validated PoC·결과 확정 | [#8](https://github.com/SASTsimi/sastsimi/issues/8) | 조근석 `@Potatonion` | `review/dynamic-sandbox` | `04`, `07`, `08`, `10`, `13` | R6, R4, R8, R3, R5 | OPEN |
