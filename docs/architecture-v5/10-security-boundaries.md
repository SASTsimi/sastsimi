...
- 통과 뒤 R7 Sandbox Setup Automation이 가설마다 clean Sandbox를 만들고, Reproduction Agent가 환경·Health Check·PoC·관찰·retry를 자율 수행한다. 실제 environment·recipe와 모든 action event는 같은 request·plan·attempt로 연결한다.
