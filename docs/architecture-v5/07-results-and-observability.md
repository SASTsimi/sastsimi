...
| Technical Gate 실행 오류·보완 한도 초과 | Gate work `FAILED` | 기술 verdict 유지, R5-02 진입 차단 |
...
| `TECHNICAL_GATE_ERROR` | Technical Gate runtime | R5-02 진입 차단 | 공통 retry 계약에 따른 Gate 재시도 또는 종료 |
