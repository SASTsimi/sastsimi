...
- Dynamic Reproduction Agent 호출 여부와 append-only AgentLog, recipe·실제 환경·container lifecycle, Sandbox profile 외부 격리 경계 차단과 Controller 판정, 정리 필요 여부와 상태가 공통 계약에 맞는지
