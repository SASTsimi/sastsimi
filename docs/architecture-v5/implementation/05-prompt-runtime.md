...
| 역할 | model profile key | provider set | limits | retry | tool | redaction | session |
|---|---|---|---|---|---|---|---|
| HYPOTHESIS | `model.hypothesis.quality-v1` | `providers.r3-04-accepted-v1` | `limits.hypothesis.v1` | `retry.standard.v1` | `tools.none.v1` | `redaction.default.v1` | NEW |
...
| VERIFICATION | `model.verification.quality-v1` | `providers.r3-04-accepted-v1` | `limits.verification.v1` | `retry.verification.v1` | `tools.none.v1` | `redaction.default.v1` | NEW |
| R7_AGENT | `model.r7-agent.quality-v1` | `providers.r3-04-accepted-v1` | `limits.r7-agent.v1` | `retry.r7-agent.v1` | `tools.r7-sandbox-inner.v1` | `redaction.sandbox.v1` | NEW |
