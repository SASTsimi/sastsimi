...
B1과 B4는 R3-05에서 해결했다. B2는 이 문서에 기록된 R5·R4 결정으로 완료됐다. B3·B5 Blocker는 R3-06 최종 구현 기준을 닫기 전에 해결해야 한다. 해결 전에도 R3-02·R3-03의 테스트 설계는 시작할 수 있지만 실제 production pipeline 구현 완료를 선언할 수 없다.
